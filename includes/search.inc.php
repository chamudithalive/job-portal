...
if(isset($_POST['input'])){
  ...
  $sql = "SELECT * FROM job WHERE jobtitle LIKE '%$input%'";
    ...
    while($row = $result->fetch_assoc()) {
      ...
      while($row1 = $result1->fetch_assoc()) {
        ...
        <div class="attachment-block clearfix">
          <img class="attachment-img" src="jobprovider/uploads/<?php echo $row1['logo']; ?>" alt="Attachment Image">
          <div class="attachment-pushed">
            <h4 class="attachment-heading"><a href="view-job.php?id=<?php echo $row['id_job']; ?>"><?php echo $row['jobtitle']; ?></a> <span class="attachment-heading pull-right">$<?php echo $row['maximumsalary']; ?>/Month</span></h4>
            <div class="attachment-text">
              <div><strong><?php echo $row1['companyname']; ?> | Experience <?php echo $row['experience']; ?> Years</strong></div>
              </div>
            </div>
