            ...
            <div class="row latest-job margin-top-50 margin-bottom-20">
              ...
              <div class="col-md-6 latest-job ">
                <div class="small-box bg-yellow padding-5">
                  ...
                  <a href="jobseeker/jobseeker-login.php" class="small-box-footer">
              ...
              <div class="col-md-6 latest-job ">
                <div class="small-box bg-red padding-5">
                  <div class="inner">
                    <h3 class="text-center">Job Provider Login</h3>
                  </div>
                  <a href="jobprovider/jobprovider-login.php" class="small-box-footer">
                    Login <i class="fa fa-arrow-circle-right"></i>
                  </a>
                </div>
              </div>
